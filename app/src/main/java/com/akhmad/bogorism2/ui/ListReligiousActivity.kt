...
class ListReligiousActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_religious)
    ...
    private fun showRecyclerList() {
        ...
        rvUser.apply {
            layoutManager = LinearLayoutManager (this@ListReligiousActivity)
            adapter = listUserAdapter
            setHasFixedSize(true)
        }
        listUserAdapter.setOnItemClickCallback(object : ListUserAdapter.OnItemClickCallback {
            override fun onItemClicked(data: User) {
                val intentToDetail = Intent(this@ListReligiousActivity, DetailActivity::class.java)
