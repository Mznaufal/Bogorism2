...
class ListNatureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_nature)
    ...
    private fun showRecyclerList() {
        ...
        rvUser.apply {
            layoutManager = LinearLayoutManager (this@ListNatureActivity)
            adapter = listUserAdapter
            setHasFixedSize(true)
        }
        listUserAdapter.setOnItemClickCallback(object : ListUserAdapter.OnItemClickCallback {
            override fun onItemClicked(data: User) {
                val intentToDetail = Intent(this@ListNatureActivity, DetailActivity::class.java)
